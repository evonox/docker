...
// Typedefs
import {VelocityEasingFn, isFunction, isString} from "./types";
 ...
 * function.
 */
export function linearEasing(percentComplete: number, startValue: number, endValue: number, property?: string) {
